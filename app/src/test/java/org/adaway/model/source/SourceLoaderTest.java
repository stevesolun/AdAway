...
public class SourceLoaderTest {
    ...
    static {
        ...
        // The following are generally valid if the wildcards match at least against a
        // single [a-zA-Z],
        // or even [a-zA-Z0-9] in some circumstances.
        // However, keep in mind that they can also match against invalid host names,
        // like when matching a
        // single [-_.] or empty string. But, because this is a white list, this is not
        // an issue for us.
        ...
        // The following cannot be valid in any circumstance, because they can never
        // match against a valid host name.
