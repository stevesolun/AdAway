...
`release-license-boundary-reports`, plus `ux_signoff_report_base64`, the
base64-encoded `ux-signoff-report.md` generated by `verify-ux-signoff.ps1`.
...
decode the generated UX sign-off report, run `verify-release-readiness.ps1`,
